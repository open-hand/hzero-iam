...
public class UserSelfServiceImpl implements UserSelfService {
    ...
    public void selfUpdatePassword(UserPasswordDTO userPasswordDTO) {
        ...
        // 校验原密码是否正确
        BasePasswordPolicy passwordPolicy = passwordPolicyRepository.selectPasswordPolicy(self.getTenantId());
     ...
     * @param user 用户
     */
    protected void sendMessageAfterUpdatePassword(User user) {
        // 发送站内信
