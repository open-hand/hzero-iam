...
public class PasswordPolicy extends AuditDomain {
    ...
    public String toString() {
        return "PasswordPolicy{" +
                ...
                ", notRecentCount=" + notRecentCount +
                ", enablePassword=" + enablePassword +
                ", enableSecurity=" + enableSecurity +
                ", enableLock=" + enableLock +
                ", lockedExpireTime=" + lockedExpireTime +
                ", enableCaptcha=" + enableCaptcha +
                ", maxCheckCaptcha=" + maxCheckCaptcha +
                ", enableWebMultipleLogin=" + enableWebMultipleLogin +
                ", enableAppMultipleLogin=" + enableAppMultipleLogin +
                ", passwordUpdateRate=" + passwordUpdateRate +
                ", passwordReminderPeriod=" + passwordReminderPeriod +
                ", forceModifyPassword=" + forceModifyPassword +
                '}';
    }
}
