...
public class MemberRoleSiteController extends BaseController {
    ...
    public ResponseEntity<List<RoleVO>> listAllUserRoles(@Encrypt @PathVariable Long userId,
                                                      MemberRoleSearchDTO memberRoleSearchDTO) {
        return Results.success(roleRepository.listMemberRoles(userId, HiamMemberType.USER, memberRoleSearchDTO));
    }
    ...
    public ResponseEntity<List<RoleVO>> listAllClientRoles(@Encrypt @PathVariable Long clientId,
                                                        MemberRoleSearchDTO memberRoleSearchDTO) {
        return Results.success(roleRepository.listMemberRoles(clientId, HiamMemberType.CLIENT, memberRoleSearchDTO));
    }
    ...
    public ResponseEntity batchDeleteMemberRole(@RequestBody List<MemberRole> memberRoleList) {
    ...
    @Permission(level = ResourceLevel.SITE)
    @DeleteMapping
    public ResponseEntity revokeMemberRoles(@RequestBody List<MemberRole> memberRoleList) {
        memberRoleService.batchDeleteMemberRole(Constants.SITE_TENANT_ID, memberRoleList);
        return Results.success();
    }
